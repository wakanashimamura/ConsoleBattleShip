...
const std::string Game::PLAYER1_FILE_NAME   = "player1Data.bin";
const std::string Game::PLAYER2_FILE_NAME   = "player2Data.bin";
const std::string Game::BOT_FILE_NAME       = "botData.bin";
const std::string Game::GAME_MODE_FILE_NAME = "gameModeData.bin";

Game::Game()
    : player1({25, 9}, "Player1"),
      player2({56, 9}, "Player1"),
      isLoadGame(true),
      isGameRunning(false),
